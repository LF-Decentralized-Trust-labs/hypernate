...
class RegistryTest {
  ...
  class when_must_read {
    ...
    @Test
    void given_empty_ledger_with_insufficient_key_parts_then_throw_key_arity() {
      assertThrows(KeyArityException.class, () -> registry.mustRead(TestEntity.class, entity.foo));
      verifyNoMoreInteractions(stub);
    }
    ...
    @Test
    void given_existing_entity_with_insufficient_key_parts_then_throw_key_arity() {
      assertThrows(KeyArityException.class, () -> registry.mustRead(TestEntity.class, entity.foo));
      verifyNoMoreInteractions(stub);
    }
  ...
  class when_try_read {
    ...
    @Test
    void given_empty_ledger_with_insufficient_key_parts_then_throw_key_arity() {
      assertThrows(KeyArityException.class, () -> registry.tryRead(TestEntity.class, entity.foo));
      verifyNoMoreInteractions(stub);
    }
